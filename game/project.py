...
#structured query lang..............relational db management
#pyuic5
...
if __name__ == "__main__":
    import sqlite3#simple command-line utility  that allows the user to manually enter and execute SQL
#statements against an SQLite database.
    conn = sqlite3.connect('cricket.db')#db is file extension for database
    import sys
